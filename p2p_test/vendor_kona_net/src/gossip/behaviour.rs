...
pub enum BehaviourError {
    ...
    SubscriptionFailed,
    /// Identify config creation failed.
    #[error("identify config creation failed")]
    IdentifyCreationFailed,
}
...
impl Behaviour {
    ...
    pub fn new(
        ...
        let identify = identify::Behaviour::new(
            identify::Config::new("/kona-net/0.1.0".into(), keypair.public())
                .with_agent_version("kona-net/0.1.0".into())
