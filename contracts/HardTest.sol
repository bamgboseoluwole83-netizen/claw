...
// ============================================================
// HardTest: Multi-vulnerability contract for adaptive agent
//
// Vulnerability classes:
//   1. Oracle storage overwrite — setPrice(uint256) no guard
//   2. DELEGATECALL proxy oracle — detection of 0xf4
//   3. Gated oracle — prepare() + setPriceGated(uint256)
//   4. Unguarded withdrawAll on lending pool
//   5. Multiple known oracle view selectors
// ============================================================
...
contract HardOracleImpl {
    ...
    // DIRECT: No guard — single-step price manipulation
    function setPrice(uint256 newPrice) external {
        price = newPrice;
    }

    // GATED: Requires prepare() first — two-step combo
...
contract HardLender {
    ...
    // Unguarded critical function — access control vuln
